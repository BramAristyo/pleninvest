  ...
  <div id="app">
    ...
    <header class="header">
      ...
      <div class="header-right">
        ...
        <div class="gs-pill" style="border-color: var(--bad); color: var(--bad); background: rgba(212, 115, 115, 0.1);"
          onclick="lockApp()">
          <span>Logout 🚪</span>
        </div>
    ...
    <div class="container">
          ...
          <div class="brand-text">
            ...
            <div class="brand-pills">
              <div class="brand-pill">
                ...
                <div class="brand-pill-desc">Kelimpahan bukan tentang berapa banyak yang kamu punya, tapi seberapa kamu
                  bisa menghidupi hidup.</div>
              </div>
              <div class="brand-pill">
                <div class="brand-pill-why">What · Apa</div>
                <div class="brand-pill-name">Plan-Invest</div>
                <div class="brand-pill-desc">Rencanakan setiap rupiah dengan tujuan — bukan impulsif, tapi penuh hikmat.
                </div>
              </div>
              <div class="brand-pill">
                <div class="brand-pill-why">What For · Rencana Dalam Memberi</div>
                <div class="brand-pill-name">Plan-in-Vest</div>
                <div class="brand-pill-desc">Rencana keuangan ini bertujuan agar semakin dapat memberi kehidupan bagi
                  seluruh ciptaan.</div>
              </div>
            </div>
          </div>
      ...
      <div class="tabs-wrap">
        <div class="tabs">
          ...
          <button class="tab-btn" data-tab="asuransi" onclick="switchTab('asuransi',this)">🛡️ Proteksi &amp;
            Manfaat</button>
      ...
      <div class="section active" id="tab-beranda">
        ...
        <div class="g4">
          <div class="stat-pill">
            ...
            <div class="stat-val inc" id="b-inc">Rp 0</div>
          </div>
          <div class="stat-pill">
            <div class="stat-label">Pengeluaran</div>
            <div class="stat-val exp" id="b-exp">Rp 0</div>
          </div>
          <div class="stat-pill">
            <div class="stat-label">Surplus</div>
            <div class="stat-val bal" id="b-bal">Rp 0</div>
          </div>
          <div class="stat-pill">
            <div class="stat-label">Net Worth</div>
            <div class="stat-val gold-c" id="b-nw">Rp 0</div>
          </div>
        </div>

        <div class="g2">
          <div class="stat-pill">
            <div class="stat-label">Portofolio Diversifikasi</div>
            <div class="stat-val bal" id="b-port">Rp 0</div>
          </div>
          <div class="stat-pill">
            <div class="stat-label">Reimburse Pending</div>
            <div class="stat-val" style="color:var(--lake-deep)" id="b-rmb">Rp 0</div>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div id="level-display" style="padding:14px;background:var(--sage-pale);border-radius:var(--radius-sm)">
            <div
              style="font-size:11px;color:var(--medium);margin-bottom:6px;text-transform:uppercase;letter-spacing:.5px">
              Level Keuangan</div>
            <div id="level-title"
              style="font-family:'Syne',sans-serif;font-size:18px;font-weight:700;color:var(--forest-dark)">Isi data untuk
              melihat level</div>
      ...
      <div class="section" id="tab-catat">
        ...
        <div class="g3">
          <div class="stat-pill">
            ...
            <div class="stat-val inc" id="c-inc">Rp 0</div>
          </div>
          <div class="stat-pill">
            <div class="stat-label">Pengeluaran</div>
            <div class="stat-val exp" id="c-exp">Rp 0</div>
          </div>
          <div class="stat-pill">
            <div class="stat-label">Sisa</div>
            <div class="stat-val bal" id="c-bal">Rp 0</div>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div class="g2">
            ...
            <div class="field"><label>Keterangan</label><input type="text" id="txn-note"
                placeholder="Contoh: Gaji Mei..."></div>
          </div>
          <div class="g2">
          ...
          <div class="field" id="benefit-note-wrap" style="display:none"><label>Keterangan
              Tunjangan/Asuransi</label><input type="text" id="txn-benefit-note"
              placeholder="Contoh: Tunjangan transportasi, klaim BPJS..."></div>
        ...
        <div class="card" style="border:1.5px dashed var(--sage-light)">
          <div class="collapse-toggle" onclick="toggleHistorical()"
            style="display:flex;align-items:center;justify-content:space-between;cursor:pointer;padding-bottom:0;border-bottom:none">
          ...
          <div id="hist-body" style="display:none;margin-top:14px">
            <div
              style="background:var(--lake-pale);border-radius:8px;padding:9px 13px;margin-bottom:12px;font-size:12px;color:var(--lake-deep)">
              Masukkan transaksi lama sekaligus. Pilih bulan &amp; tahun, isi transaksi, lalu simpan semua.</div>
            <div class="g2">
        ...
        <div class="card">
          ...
          <div class="txn-hdr"><span>Tgl</span><span>Kategori · Ket.</span><span>Benefit</span><span
              style="text-align:right">Nominal</span><span></span></div>
        ...
        <div class="card">
          ...
          <div class="g2">
            ...
            <div>
              <div
                style="font-size:10px;color:var(--medium);text-transform:uppercase;letter-spacing:.5px;margin-bottom:4px">
                Net Worth</div>
              <div id="nw-val" style="font-family:'Syne',sans-serif;font-size:22px;font-weight:800;color:var(--charcoal)">
                Rp 0</div>
            </div>
      ...
      <div class="section" id="tab-divers">
        ...
        <div class="g4">          <div class="stat-pill">
          ...
          <div class="stat-pill">
            ...
            <div class="stat-val" style="color:var(--medium)" id="d-modal">Rp 0</div>
          </div>
          <div class="stat-pill">
            <div class="stat-label">Untung/Rugi</div>
            <div class="stat-val" id="d-pl">Rp 0</div>
          </div>
          <div class="stat-pill">
            <div class="stat-label">Return (%)</div>
            <div class="stat-val" id="d-ret">0%</div>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <button class="btn btn-outline btn-sm" style="margin-top:12px;width:auto" onclick="toggleAddAsset()">＋ Tambah
            Aset</button>
        </div>
        ...
        <div class="card" id="add-asset-card" style="display:none">
          ...
          <div class="g2">
            ...
            <div class="field"><label>Nama / Label</label><input type="text" id="a-name"
                placeholder="Contoh: BCA, ANTM, USD..."></div>
          </div>
          <div class="g2">
          ...
          <div class="g2">
            <div class="field"><label>Jumlah / Lot / Gram</label><input type="number" id="a-qty" placeholder="1"
                min="0.001" step="0.001"></div>
            <div class="field"><label>Ticker / Kode (opsional)</label><input type="text" id="a-ticker"
                placeholder="Contoh: BBCA.JK, XAU, USD"></div>
          </div>
          <div class="field"><label>Keterangan</label><input type="text" id="a-note" placeholder="Catatan tambahan...">
          </div>
          <div class="g2">
        ...
        <div class="ai-panel" id="ai-panel">
          ...
          <div class="ai-content" id="ai-content">
            <div style="font-size:12px;color:rgba(255,255,255,.6);margin-bottom:12px">Dapatkan saran diversifikasi terbaik
              berdasarkan portofoliomu saat ini.</div>
            <button onclick="getAIReco()"
              style="background:rgba(255,255,255,.15);border:1px solid rgba(255,255,255,.3);color:#fff;padding:9px 18px;border-radius:100px;font-family:'Inter',sans-serif;font-size:12px;font-weight:500;cursor:pointer;">✨
              Minta Saran AI</button>
          </div>
        </div>
      </div>
      ...
      <div class="section" id="tab-reimburse">
        <div class="g3">
          <div class="stat-pill">
            <div class="stat-label">Total Reimburse (Bulan Ini)</div>
            <div class="stat-val" style="color:var(--lake-deep)" id="r-total">Rp 0</div>
          </div>
          <div class="stat-pill">
            <div class="stat-label">Pending</div>
            <div class="stat-val" style="color:var(--warn)" id="r-pending">Rp 0</div>
          </div>
          <div class="stat-pill">
            <div class="stat-label">Sudah Diterima</div>
            <div class="stat-val" style="color:var(--good)" id="r-received">Rp 0</div>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div style="display:flex;gap:8px;margin-bottom:12px;flex-wrap:wrap">
            <select id="r-filter-cat" onchange="renderReimburse()"
              style="padding:7px 11px;border:1.5px solid var(--border);border-radius:var(--radius-sm);font-family:'Inter',sans-serif;font-size:12px;background:var(--cream);outline:none">
            ...
            <select id="r-filter-status" onchange="renderReimburse()"
              style="padding:7px 11px;border:1.5px solid var(--border);border-radius:var(--radius-sm);font-family:'Inter',sans-serif;font-size:12px;background:var(--cream);outline:none">
          ...
          <div class="rmb-hdr"><span>Tgl</span><span>Kategori</span><span>Keterangan</span><span
              style="text-align:right">Nominal</span><span>Status</span><span></span></div>
      ...
      <div class="section" id="tab-asuransi">
        <div class="g2">
          <div class="stat-pill">
            <div class="stat-label">Total Premi / Bulan</div>
            <div class="stat-val" style="color:var(--lake-deep)" id="ins-total">Rp 0</div>
          </div>
          <div class="stat-pill">
            <div class="stat-label">Total Tunjangan / Bulan</div>
            <div class="stat-val inc" id="tnj-total">Rp 0</div>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div class="g2">
            <div class="field"><label>Nama Asuransi</label><input type="text" id="ins-name"
                placeholder="Contoh: BPJS Kesehatan, Prudential..."></div>
            <div class="field"><label>Jenis</label>
              <select id="ins-type">
          ...
          <div class="field"><label>Coverage / Keterangan</label><input type="text" id="ins-coverage"
              placeholder="Contoh: Rawat inap hingga 1M..."></div>
        ...
        <div class="card">
          ...
          <div class="g2">
            <div class="field"><label>Nama Tunjangan</label><input type="text" id="tnj-name"
                placeholder="Contoh: Tunjangan transportasi..."></div>
            <div class="field"><label>Kategori</label>
              <select id="tnj-type">
        ...
        <div class="card">
          ...
          <div id="ins-list">
            <div class="empty-state">
              <div class="ei">🛡️</div>Belum ada asuransi tercatat
            </div>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div id="tnj-list">
            <div class="empty-state">
              <div class="ei">💼</div>Belum ada tunjangan tercatat
            </div>
          </div>
        </div>
        ...
        <div class="card" style="border:1.5px solid #D4A843" id="cicilan-emas-card">
          ...
          <div class="card-sub">Beli emas bertahap dengan cicilan. Tracking gram terbeli, progress bayar, dan nilai vs
            modal.</div>
          <button class="btn btn-outline btn-sm" style="width:auto;margin-bottom:12px" onclick="toggleCicilanForm()">+
            Tambah Cicilan Emas</button>
          <div id="cicilan-form" style="display:none;padding-top:12px;border-top:1px solid var(--border)">
            <div class="g2">
              <div class="field"><label>Nama / Label</label><input type="text" id="ce-name"
                  placeholder="Contoh: Emas Antam 2gr"></div>
      ...
      <div class="section" id="tab-grafik">
        <div class="chart-grid">
          <div class="chart-card">
            ...
            <div class="donut-wrap"><canvas id="ch-expense-donut"></canvas>
              <div class="donut-center">
                <div class="donut-cv" id="dnut-exp-total">—</div>
                <div class="donut-cl">Pengeluaran</div>
              </div>
            </div>
          ...
          <div class="chart-card">
            ...
            <div class="donut-wrap"><canvas id="ch-asset-donut"></canvas>
              <div class="donut-center">
                <div class="donut-cv" id="dnut-asset-total">—</div>
                <div class="donut-cl">Portofolio</div>
              </div>
            </div>
      ...
      <div class="section" id="tab-kesehatan">
        ...
        <div class="score-card">
          ...
          <div id="score-badge" class="level-badge" style="background:var(--sage-pale);color:var(--forest)">Isi data dulu
            🌱</div>
        ...
        <div class="card">
          ...
          <div class="metric-row">
            <div>
              <div class="metric-name">Rasio Tabungan</div>
              <div class="metric-sub">Target: ≥ 20% pemasukan · Pakar: Ramit Sethi</div>
              <div class="prog-bar">
                <div class="prog-fill fill-g" id="pb-sav" style="width:0%"></div>
              </div>
            </div>
            <div style="text-align:right">
              <div class="metric-val" id="mv-sav">—</div>
              <div id="mp-sav"></div>
            </div>
          </div>
          <div class="metric-row">
            <div>
              <div class="metric-name">Rasio Utang</div>
              <div class="metric-sub">Target: &lt;30% pemasukan · Consumer Financial Protection Bureau</div>
              <div class="prog-bar">
                <div class="prog-fill fill-g" id="pb-dbt" style="width:0%"></div>
              </div>
            </div>
            <div style="text-align:right">
              <div class="metric-val" id="mv-dbt">—</div>
              <div id="mp-dbt"></div>
            </div>
          </div>
          <div class="metric-row">
            <div>
              <div class="metric-name">Dana Darurat</div>
              <div class="metric-sub">Target: 6–9 bulan pengeluaran · Vanguard Research</div>
              <div class="prog-bar">
                <div class="prog-fill fill-g" id="pb-em" style="width:0%"></div>
              </div>
            </div>
            <div style="text-align:right">
              <div class="metric-val" id="mv-em">—</div>
              <div id="mp-em"></div>
            </div>
          </div>
          <div class="metric-row">
            <div>
              <div class="metric-name">Rasio Hidup</div>
              <div class="metric-sub">Target: &lt;80% pemasukan · Harvard Joint Center</div>
              <div class="prog-bar">
                <div class="prog-fill fill-w" id="pb-lv" style="width:0%"></div>
              </div>
            </div>
            <div style="text-align:right">
              <div class="metric-val" id="mv-lv">—</div>
              <div id="mp-lv"></div>
            </div>
          </div>
          <div class="metric-row">
            <div>
              <div class="metric-name">Persepuluhan</div>
              <div class="metric-sub">Komitmen imanmu — tercatat, bukan dinilai</div>
            </div>
            <div style="text-align:right">
              <div class="metric-val" id="mv-tth">—</div><span class="pill pill-neu">📖 Iman</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="section" id="tab-tips">
        <div class="card" style="background:linear-gradient(135deg,var(--forest-dark),var(--forest));border:none">
          <div style="color:#fff">
            <div style="font-family:'Syne',sans-serif;font-size:16px;font-weight:700;margin-bottom:6px">🌳 Filosofi
              Pleninvest</div>
            <div style="font-size:13px;color:rgba(255,255,255,.8);font-weight:300;line-height:1.7">Seperti pohon yang
              bertumbuh perlahan tapi pasti — keuangan yang sehat bukan dibangun dalam semalam, tapi dirawat setiap hari
              dengan konsistensi, kejujuran, dan hikmat. Sebagai calon pendeta, ketenangan finansialmu adalah bagian dari
              panggilanmu.</div>
          </div>
        </div>
      ...
      <div class="section" id="tab-sheets">
        ...
        <div class="card">
          ...
          <div class="setup-step">
            ...
            <div>
              <div class="step-title">Buat Google Sheet Baru</div>
              <div class="step-body">Buka <strong>sheets.google.com</strong> → klik "+ Blank" → beri nama <em>"Pleninvest
                  - Ricky Atmoko"</em>.</div>
            </div>
          </div>
          <div class="setup-step">
            ...
            <div>
              <div class="step-title">Buka Apps Script</div>
              <div class="step-body">Di Google Sheets: klik <strong>Extensions → Apps Script</strong>. Hapus semua kode
                yang ada, paste kode berikut:</div>
          ...
          <div class="setup-step">
            ...
            <div>
              ...
              <div class="step-body">Klik <strong>Deploy → New Deployment</strong> → pilih type <strong>Web
                  app</strong>.<br>• Execute as: <strong>Me</strong><br>• Who has access: <strong>Only
                  myself</strong><br>→ Klik <strong>Deploy</strong>, izinkan akses Google, lalu <strong>salin URL yang
                  muncul</strong>.</div>
            </div>
          </div>
          <div class="setup-step">
            ...
            <div>
              <div class="step-title">Paste URL di atas & Hubungkan</div>
              <div class="step-body">Tempel URL di kolom koneksi di atas → klik Hubungkan. Selesai! 🎉 Semua datamu akan
                sync otomatis.</div>
            </div>
          </div>
          <div class="setup-step">
            ...
            <div>
              <div class="step-title">Keamanan Terjamin</div>
              <div class="step-body">"Only myself" means only your Google account can access this endpoint. Even if the
                URL leaks, others cannot read or write your data without logging into your Google account.</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footnote">🌳 Pleninvest by Ricky Atmoko · Data tersimpan oleh system · Privasi 100% ada di tanganmu</div>
  </div><!-- end app -->
@endsection